...
const AppointmentModal = ({ isOpen, onClose, serviceName }) => {
            ...
            <AnimatePresence mode="wait">
              {view === 'choice' && (
                ...
                >
                  <h3 className="text-xl font-bold text-center mb-6 text-[var(--text-primary)]">
                    {serviceName ? `Book ${serviceName}` : 'Choose Your Booking Method'}
                  </h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <WhatsAppButton
                      ...
                      message={`Hello! I'm interested in ${serviceName ? `booking for ${serviceName}` : 'booking an appointment'} with MOWET Kenya.`}
              ...
              {view === 'form' && (
                ...
                >
                  ...
                  <ModalContactForm
                    onClose={handleClose}
                    title={serviceName ? `Inquiry: ${serviceName}` : "Appointment Request (In-Modal)"}
                  />
                </motion.div>
              )}
            </AnimatePresence>
